...
const STATIC_PAGES: MetadataRoute.Sitemap = [
  ...
  { url: `${BASE}/video-production/`,          lastModified: new Date(), changeFrequency: 'monthly', priority: 0.8 },
  ...
  { url: `${BASE}/ai-products/`,                 lastModified: new Date(), changeFrequency: 'monthly', priority: 0.7 },
  { url: `${BASE}/design-factory/`,              lastModified: new Date(), changeFrequency: 'monthly', priority: 0.8 },
  ...
  { url: `${BASE}/ux-audit/`,                lastModified: new Date(), changeFrequency: 'monthly', priority: 0.7 },
  { url: `${BASE}/research-for-branding/`,    lastModified: new Date(), changeFrequency: 'monthly', priority: 0.7 },
