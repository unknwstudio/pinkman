...
const STATIC_PAGES: MetadataRoute.Sitemap = [
  ...
  { url: `${BASE}/outstaff-designers/`,        lastModified: new Date(), changeFrequency: 'monthly', priority: 0.8 },
  { url: `${BASE}/outstaff-designers/ai/`,    lastModified: new Date(), changeFrequency: 'monthly', priority: 0.7 },
